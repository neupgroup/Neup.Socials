...
export async function recordOutgoingMessageAction({ conversationId, channelId, contactId, contactName, platform, text, avatar }: { conversationId?: string; channelId: string; contactId: string; contactName: string; platform: string; text: string; avatar?: string | null }) {
