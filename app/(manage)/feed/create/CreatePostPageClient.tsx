    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Write your post and optionally add media. This will serve as the base for all platforms.
          </CardDescription>
        </CardHeader>
            ...
            <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-2">
              ...
              {loadingUploads ? (
                Array.from({ length: 7 }).map((_, i) => (
                  <div key={i} className="aspect-square w-full rounded-md bg-muted animate-pulse" />
                ))
              ) : (
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <Facebook className="h-5 w-5 text-blue-600" /> Facebook Options
          </CardTitle>
          <CardDescription>
            Add a Call To Action button to your Facebook post (optional, may not appear on organic posts).
          </CardDescription>
        </CardHeader>
