...
export default function SelectPlatformsPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      <div>
        <h1 className="text-3xl font-bold">Select Platforms</h1>
      ...
      <div className="flex justify-between">
         <Button asChild variant="outline">
          <Link href="/content/create">Previous: Edit Content</Link>
        </Button>
        <Button asChild>
          <Link href="/content/create/schedule">Next: Schedule Post</Link>
        </Button>
      </div>
    </div>
  );
